...
struct AgentAbilitiesTitle: View {
    
    // MARK: Variable
    var agent: Agent
    
    var body: some View {
        Text(LocalizedStringKey("AbilitiesTitle"))
...
struct AgentAbilitiesTitle_Previews: PreviewProvider {
    static var previews: some View {
        ...
        AgentAbilitiesTitle(agent: agent)
    }
}
